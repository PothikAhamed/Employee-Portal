    ...
    <div className="w-full px-4 md:px-10 mt-10">
      <div className="w-full max-w-7xl mx-auto bg-[#1e272e] rounded-xl shadow-lg shadow-black p-5">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 mb-5">
          ...
          <button className="bg-[#1e272e] shadow shadow-black text-black px-5 py-2 rounded-lg hover:bg-gray-200">View All</button>
        </div>

        <div className="space-y-4">
          <div className="bg-[#1e272e] shadow shadow-black p-4 rounded-lg flex flex-col md:flex-row md:justify-between md:items-center gap-3">
            <div>
